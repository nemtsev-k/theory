...
ECMAScript (или ES) - спецификация языка сценариев, стандартизированная Ecma International в ECMA-262 и ISO / IEC 16262. Он был создан для стандартизации JavaScript, чтобы способствовать развитию множества независимых реализаций. JavaScript остается наиболее известной реализацией ECMAScript с момента первой публикации стандарта, наряду с другими хорошо известными реализациями, включая JScript и ActionScript. ECMAScript обычно используется для написания сценариев на стороне клиента во Всемирной паутине и все чаще используется для написания серверных приложений и служб с использованием Node.js. 

## Расширения

* **jQuery** — библиотека JavaScript, фокусирующийся на взаимодействии JavaScript и HTML. Библиотека jQuery помогает легко получать доступ к любому элементу DOM, обращаться к атрибутам и содержимому элементов DOM, манипулировать ими. Также библиотека jQuery предоставляет удобный API для работы с AJAX.
* [TypeScript](ts.md)
* [React](react.md)
* [Vue](vue.md)
* [Angular](angular.md)
